...
<article>
	<main class="container-fluid">
		...
		<p>Philipp Sch&uuml;tz<br />
			c/o IP-Management #43434<br />
			Ludwig-Erhard-Str. 18<br />
			20459 Hamburg</p>
		<p>E-Mail: mail@philippschuetz.com</p>
		...
		<p>Sie haben das Recht, Daten, die wir auf Grundlage
			Ihrer Einwilligung oder in Erf&uuml;llung eines Vertrags automatisiert verarbeiten, an sich oder an einen Dritten
			in
